...
export class EventProcessor {
    async run(req: APIGatewayRequest): Promise<any> {
        ...
        console.log(JSON.stringify(process.env.CodeBuildProjectName));
        let codeBuildProjectName= JSON.stringify(process.env.CodeBuildProjectName);
        await this.runBuild(codebuild,"testing-cicd-codebuild-java", sourceVersion, sourceVersion);
